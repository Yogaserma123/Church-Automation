                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="basic-form">
                                    <form action="{{route('goto_familytable')}}" method="POST">
                                      {{csrf_field()}}
                                        <div class="form-row">                                            
                                          <label class="col-sm-4 col-form-label" style="text-align:right;">FROM:</label>
                                            <div class="col-sm-6">
                                                <input type="date" class="form-control" placeholder="" value="<?php echo date('Y-m-d'); ?>" name="d1">
                                            </div>
                                        </div><br>
                                        <div class="form-row">                                            
                                          <label class="col-sm-4 col-form-label"style="text-align:right;">TO:</label>
                                            <div class="col-sm-6">
                                                <input type="date" class="form-control" placeholder="" value="<?php echo date('Y-m-d'); ?>" name="d2">
                                            </div>
                                        </div><br>                                        
