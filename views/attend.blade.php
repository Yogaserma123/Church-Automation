  ...
  <body>
          ...
          <div class="col-xl-12 col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Attandance Page</h4>
                            </div>
                            <div class="card-body">
    ...
    @foreach($san as $sun)
        <tr>
            ...
            <td>{{ $sun->slno }}</td>
            <td class="btnSelect_1"><span style="cursor:pointer; color:green;" class="material-symbols-outlined">Present</span></td>
            <td><input type="text" name="" placeholder="Reason"></td>
            <td class="btnSelect_2"><span style="cursor:pointer; color:red; font-style:bold;" class="material-symbols-outlined">Absent</span></td>
            <td>{{ $sun->gender }}</td>
            <td>{{ $sun->mobile }}</td>
    ...
    $(document).ready(function(){
        $(".btnSelect_1").click(function(){
            ...
            const msg = confirm("Are you sure you want to do that?");
            if(msg){
                $.ajax({
                    url: "{{ route('attend') }}",
                    method: "GET",
                    data:{flno:flno, remark:remark, attend_entry:attend_entry, fname:fname, fphone:fphone},
