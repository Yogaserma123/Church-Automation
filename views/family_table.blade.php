                       ...
                       <div class="col-xl-12 col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Family List Page</h4>
                            </div>
              
                            <div class="card-body">
                            <div class="table-responsive">
                                    <table id="tbl_exporttable_to_xls" class="display" style="min-width: 845px">
                                        <thead>
                                            <tr>
                                                <th>Edit</th> 
                                                <th>Family NO</th>
...
@foreach($san as $sun)
<tr>
  <td><a href="{{route('familyedit', $sun->id)}}">Edit</a></td>
<td>{{$sun->fno}}</td>
<td>{{$sun->family_head_name}}</td>
<td>{{$sun->family_photo}}</td>
<td>{{$sun->slno}}</td>
<td>{{$sun->family_member_name}}</td>
<td>{{$sun->gender}}</td>
<td>{{$sun->relation}}</td>
<td>{{$sun->occupation}}</td>
<td>{{$sun->dob}}</td>
<td>{{$sun->marriage_date}}</td>
<td>{{$sun->baptism_date}}</td>
<td>{{$sun->mobile}}</td>
<td>{{$sun->ad_no}}</td>
<td>{{$sun->joining_date}}</td>
<td>{{$sun->member_status}}</td>
<td>{{$sun->member_saved}}</td>
<td>{{$sun->member_photo}}</td>
<td>{{$sun->street}}</td>
<td><a onclick="return confirm('Are you Delete this item?')" href=" {{route('familydelete', $sun->id)}}">delete</a></td>
</tr>
@endforeach
</tbody>
</table>
