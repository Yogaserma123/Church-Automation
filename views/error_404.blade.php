...
<div class="col-xl-12 col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Receipt Report List</h4>
                            </div>
                            <div class="card-body">
...
@foreach($san as $sun)
<tr>
<td>{{$sun->receipt_date}}</td>
<td>{{$sun->rno}}</td>
<td>{{$sun->offering}}</td>
<td>{{$sun->description}}</td>
<td>{{$sun->amount_type}}</td>
<td>{{$sun->amount}}</td>
<td><a onclick="return confirm('Are you Delete this item?')" href=" {{route('index4', $sun->id)}}">delete</a></td>
<td><a href="{{route('receiptprint', $sun->id)}}">print</a></td>
</tr>
@endforeach
</tbody>
</table>
