...
<div class="col-xl-12 col-lg-12">
   ...
   @foreach($san as $sun)
<tr>
<td>{{$sun->voucher_date}}</td>
<td>{{$sun->description}}</td>
<td>{{$sun->amount_type}}</td>
<td>{{$sun->amount}}</td>
<td>{{$sun->paid_to}}</td>
<td><a onclick="return confirm('Are you Delete this item?')" href=" {{route('voucherindex4', $sun->id)}}">delete</a></td>
<td><a href="{{route('voucherprint', $sun->id)}}">print</a></td>
</tr>
@endforeach
</tbody>
</table>
